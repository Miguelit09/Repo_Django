...
urlpatterns = [
    ...
    path("storage/<str:titulo>/<str:cuerpo>/<int:id_author_id>", views.storage, name="storage"),
    ...
    # path("consultar_post_por_autor/<int:id_author>", views.consultar_post_por_autor, name="consultar_post_por_autor")
]